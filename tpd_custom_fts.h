...
#define TPD_POWER_SOURCE_CUSTOM         MT6328_POWER_LDO_VGP1//modify_lwf  PMIC_APP_CAP_TOUCH_VDD to MT6328_POWER_LDO_VGP1
...
/*apgrade*/
#define TPD_AUTO_UPGRADE                //modify_lwf_del // if need upgrade CTP FW when POWER ON,pls enable this MACRO
//#define TPD_HW_REST
...
/*gesture*/
#define FTS_GESTURE     01                 // if need gesture funtion,enable this MARCO
#ifdef FTS_GESTURE
